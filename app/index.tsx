...
export default function HomeScreen() {
  ...
  function startProcessing() {
    ...
    router.push({
      pathname: '/processing',
      params: { videoUri: video.uri, videoName: video.name },
    });
  }
    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        {video ? (
          ...
          <Pressable style={styles.pickBtn} onPress={pickVideo}>
            ...
            <Text style={styles.pickBtnHint}>MP4-Format, empfohlen 1–5 Minuten</Text>
          </Pressable>
        )}
      </View>
      ...
      <View style={styles.infoBox}>
        <Text style={styles.infoText}>
          ...
          Das Gerät bleibt dabei gesperrt – bitte nicht unterbrechen.
        </Text>
      </View>
    </View>
  );
